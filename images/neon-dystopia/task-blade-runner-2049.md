...
本文件是主題研究與產圖 brief。`9.jpg`–`14.jpg` 已各換成獨立實體圖（該段依當次指示含人物）。`15.jpg` 依後續指示把 8／14 的人物與窄裙、透明絲襪、高跟鞋放進城市 OS 主畫面；`16.jpg` 改為兩件式窄裙操作者站在交通／電網圖層前；`17.jpg` 為新人物鑽入行政區模組（偏後、膚色褲襪）；`18.jpg` 為黃昏 OS 酒紅長捲髮操作者、超薄透膚黑褲襪；`19.jpg` 為體積孿生裡的酒紅捲髮操作者（正面微側、透膚黑褲襪）；`20.jpg` 為夜前操作甲板的酒紅捲髮操作者（歐美日本混血嘗試、加州陽光膚色絲褲襪）。
...
| `20` | `20.jpg` | 操作甲板＋酒紅捲髮、陽光膚色絲褲襪 | 擋風玻璃＝桌面；夜前 |
...
| `20` | `20.jpg` | 操作甲板＋正面微側操作者 | 擋風玻璃＝桌面；加州陽光膚色絲褲襪 |
