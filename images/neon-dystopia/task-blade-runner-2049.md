...
本文件是主題研究與產圖 brief。`9.jpg`–`14.jpg` 已各換成獨立實體圖（該段依當次指示含人物）。`12.jpg` 依後續指示把華勒斯水殿人物改為黑金兩件式、加大胸前鏤空、極薄黑褲襪；`15.jpg`–`17.jpg` 依後續指示改成 12／20 的剪裁：兩件式、胸前或背後鑽空、淺薄白皙絲襪；`15` 去掉大衣；`16` 酒紅兩件式；`17` 冰灰回眸；`18.jpg` 為黃昏 OS 酒紅長捲髮操作者、超薄透膚黑褲襪；`19.jpg` 為體積孿生裡的酒紅捲髮操作者（正面微側、透膚黑褲襪）；`20.jpg` 為夜前操作甲板的酒紅捲髮操作者（歐美日本混血嘗試、極薄酒紅薄紗褲襪、高領加大胸前鏤空上衣；金茶色絲光易被讀成油亮裸腿，已改色）。
...
| `16` | `16.jpg` | 交通／電網 OS＋酒紅兩件式、淺薄白皙絲襪 | 不再用實色象牙／酒紅腿 |
| `17` | `17.jpg` | 行政區模組＋冰灰回眸、淺薄白皙絲襪 | 背後鑽空；褲襪淡、薄 |
...
| `16` | `16.jpg` | 交通／電網＋酒紅兩件式 | 淺薄白皙絲襪；儀表密度升高 |
| `17` | `17.jpg` | 行政區模組＋冰灰回眸 | 背後鑽空、淺薄白皙絲襪 |
