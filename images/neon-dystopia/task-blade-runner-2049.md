...
本文件是主題研究與產圖 brief。`9.jpg`–`14.jpg` 已各換成獨立實體圖（該段依當次指示含人物）。`12.jpg` 依後續指示把華勒斯水殿人物改為黑金兩件式、加大胸前鏤空、極薄黑褲襪；`15.jpg`–`17.jpg` 依後續指示改成 12／20 的剪裁：兩件式、胸前或背後鑽空、淺薄白皙絲襪；`15` 去掉大衣；`16` 酒紅兩件式改為側坐控制台、Pretty Polly 米色 10 denier 乾透褲襪（選定 C，排除油亮 B）、上半身膚色調亮與腿對齊；`17` 冰灰回眸改為窗沿側坐、背後鑽空、迷你裙下襬再明顯上收（3 公分指令無效後改用可見的大腿露出量）、5 denier 近乎隱形乾透褲襪、膚色與腿對齊、回眸看鏡頭；`18.jpg` 為黃昏 OS 酒紅長捲髮操作者改為控制台側坐、油亮黑褲襪（B+C）；`19.jpg` 為體積孿生裡的酒紅捲髮操作者（正面微側、透膚黑褲襪）；`20.jpg` 為夜前操作甲板的酒紅捲髮操作者（歐美日本混血嘗試、極薄酒紅薄紗褲襪、高領加大胸前鏤空上衣；金茶色絲光易被讀成油亮裸腿，已改色）。
...
| `6` | `6.jpg` | 霾城露台＋冰灰兩件式、極薄黑褲襪 | 無太陽；人物拉近 |
| `7` | `7.jpg` | 機構大廳＋瀏海大衣、極薄黑褲襪 | 同一大廳拉近，腿清楚 |
| `8` | `8.jpg` | 機構大廳＋黑金短洋裝、極薄黑褲襪 | 側步拉近，與 7 同廳不同人 |
| `9–14` | 各一張獨立圖 | 已重產：LED 雨衣近景／廳堂／金階／水殿／霧堤近景／Vegas | `9` 留粉藍 LED；`13` 改灰霧堤、去掉重複 LED 牆 |
| `15` | `15.jpg` | 城市 OS＋黑金兩件式、胸前鑽空、淺薄白皙絲襪 | 大衣已拿掉；褲襪淡、薄 |
| `16` | `16.jpg` | 交通／電網 OS＋酒紅兩件式側坐、Pretty Polly 米色 10 denier 乾透褲襪 | 膚色已調亮；選定 C 乾透，不是 B 的強亮面 |
| `17` | `17.jpg` | 行政區模組＋冰灰窗沿側坐、回眸、高光油亮裸色絲襪 | 迷你裙保留；材質對齊亮面尼龍商品圖，不是內衣目錄 |
| `18` | `18.jpg` | 黃昏 OS＋酒紅捲髮側坐、微近、短裙、緞面黑褲襪 | 油光已收；青界面壓過琥珀天際線 |
...
主要缺口：蛋白農場、海堤光池、聖地牙哥垃圾／工業內臟、K 的預製小宅。粉藍 LED 雨夜與銀雪已補；`6` 已去掉太陽並拉近人物，`9`／`13` 不再共用 LED 牆。
...
| `16` | 交通／電網圖層＋酒紅兩件式側坐操作者（低髮髻、側臉） | 儀表密度升高；Pretty Polly 米色 10 denier 乾透褲襪 |
| `17` | 行政區模組＋銀短髮操作者（窗沿側坐回眸） | 更近、更幾何；冰灰兩件式；下襬再上收；5 denier 近乎隱形褲襪 |
| `18` | 黃昏 OS＋酒紅捲髮側坐 | 青界面光壓過琥珀天際線；油亮黑褲襪 |
...
| `15` | `15.jpg` | 城市 OS＋黑金兩件式 | 胸前鑽空、淺薄白皙絲襪；午後界面 |
| `16` | `16.jpg` | 交通／電網＋酒紅兩件式側坐 | Pretty Polly 米色 10 denier 乾透褲襪；膚色與腿對齊；儀表密度升高 |
| `17` | `17.jpg` | 行政區模組＋冰灰窗沿側坐回眸 | 背後鑽空、下襬再上收、5 denier 近乎隱形褲襪、膚色與腿對齊 |
| `18` | `18.jpg` | 黃昏 OS＋酒紅捲髮側坐 | 油亮黑褲襪；界面光壓過天際線 |
